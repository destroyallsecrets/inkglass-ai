...
import { ArrowRight, Mail, Lock, User, AlertCircle, Sparkles } from 'lucide-react'
      ...
      <div className="w-full max-w-md">
        ...
        >
          <p className="text-sm mt-1">
            <strong>Demo Registration:</strong> This is a demonstration registration page. 
            User data is stored locally in your browser and will be cleared when you clear 
            site data. Do not use real passwords or personal information.
          </p>
        </Alert>

        <Card variant="glass" padding="lg">
          <CardHeader>
            <CardTitle className="text-2xl text-center">Demo Registration</CardTitle>
            <p className="text-center text-ink-gray mt-2">
              Create a demo account to explore all features
            </p>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="relative">
                    <User className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-ink-gray" />
                    <input
                      type="text"
                      value={name}
              ...
              <p className="text-center text-sm text-ink-gray">
                ...
                <Link href="/dev/login" className="text-ink-black font-medium underline underline-offset-4">
                  Demo Sign In
                </Link>
              </p>
            </form>
